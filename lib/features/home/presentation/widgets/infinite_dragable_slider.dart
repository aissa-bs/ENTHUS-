...
import 'package:fitness/features/home/presentation/widgets/dragable_widget.dart';
...
// We are almost made it, it feels so good to slide
  double getScal(int stackIndex) =>
      {
        0: lerpDouble(0.6, 0.7, controller.value),
        1: lerpDouble(0.7, 0.75, controller.value),
        2: lerpDouble(0.75, 0.8, controller.value),
      }[stackIndex] ??
      0.8;
