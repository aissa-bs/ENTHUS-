...
import 'package:fitness/core/shared/domain/entities/magazine2.dart';
import 'package:fitness/core/shared/presentation/widgets/emagazine_cover_image.dart';
...
import 'package:fitness/view/expert_views/sportexpert/sportexpert_notification.dart';
...
class SportExpertHome extends StatefulWidget {
  const SportExpertHome({super.key});

  @override
  State<SportExpertHome> createState() => _SportExpertHomeState();
}

class _SportExpertHomeState extends State<SportExpertHome> {
   List whatArr = [
    {
  ...
  List lastWorkoutArr = [
    {
      "name": "Aissa Bensadia (Full Body Workout)",
    ...
    {
      "name": "Khelifa Krike (Lower Body Workout)",
    ...
    {
      "name": "Bouhadjeyr Wahab (Ab Workout)",
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>  SportExpertNotificationView(),
                              ),
                            );
              },
            ),
              ...
              child: Column(
                ...
                Center(
                  ...
                  child: InfiniteDragableSlider(
                    iteamCount: Magazine2.fakeMagazinesValues.length,
                    itemBuilder: (context, index) => EMagazineCoverImage(
                      magazine: Magazine2.fakeMagazinesValues[index],
                    ),
