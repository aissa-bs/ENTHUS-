...
import 'package:fitness/view/expert_views/sportexpert/sportprogram_created_details.dart';
import 'package:flutter/material.dart';


class SportExpertProgramsPage extends StatefulWidget {
  const SportExpertProgramsPage({super.key});

  @override
  State<SportExpertProgramsPage> createState() => _SportExpertProgramsPageState();
}

class _SportExpertProgramsPageState extends State<SportExpertProgramsPage> {
  @override
                             ...
                             child: Center(
                               child: RoundButton(
                                ...
                                onPressed: () {
                                  ...
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SportProgramcreatedDetailView(dObj: sObj, 
