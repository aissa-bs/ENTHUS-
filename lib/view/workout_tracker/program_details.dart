...
import 'package:fitness/view/workout_tracker/exersise_step.dart';
...
class ProgramDetailView extends StatefulWidget {
  ...
  const ProgramDetailView({super.key, required this.dObj});
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                    ...
                    child: Text(
                      '${( widget.dObj.progress * 100).toInt()}% ', // Display percentage
                    ...
                    children: [
                      RoundButton(title: "Start Workout", onPressed: () {
                        Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => 
                                    ExerciseStep(exercisesArr: stepAr, ),
                                  ),
                                );
                      })
                    ],
